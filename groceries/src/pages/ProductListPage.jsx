      ...
      <div className="container mx-auto px-4 py-6">
                  ...
                  .map((cat) => {
                    ...
                    return (
                      <Link
                        ...
                        to={
                          firstSubCategory
                            ? `/${valideURLConvert(cat.name)}-${
                                cat._id
                              }/${valideURLConvert(firstSubCategory.name)}-${
                                firstSubCategory._id
                              }`
                            : `/category/${valideURLConvert(cat.name)}-${
                                cat._id
                              }`
                        }
                      ...
                      >
                        <img
                          ...
                          onError={(e) => {
                            ...
                            e.currentTarget.src = noDataImage;
                          }}
                        />
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4">
              ...
              <div className="text-center sm:text-left">
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">
                  Explore our {categoryInfo.name.toLowerCase()} collection
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="sm:hidden">
              ...
              >
                <span className="font-semibold">
                  Browse {categoryInfo.name} Subcategories
                </span>
                <svg
                  className={`w-5 h-5 transition-transform ${
                    showSubCategoriesMenu ? "rotate-180" : ""
                  }`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-3 mb-2">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-gray-100 rounded overflow-hidden">
                      ...
                      subCategoryInfo.image.length > 0 ? (
                        <img
                          src={
                            Array.isArray(subCategoryInfo.image)
                              ? subCategoryInfo.image[0]
                              : subCategoryInfo.image
                          }
              ...
              {showSubCategoriesMenu && (
                <div className="bg-white rounded-lg shadow-lg border max-h-60 overflow-y-auto">
                  {allSubCategory
                    .filter((sub) =>
                      sub.category.some((cat) => cat._id === categoryInfo._id)
                    )
                    .map((sub) => (
                      <Link
                        key={sub._id}
                        to={`/${valideURLConvert(categoryInfo.name)}-${
                          categoryInfo._id
                        }/${valideURLConvert(sub.name)}-${sub._id}`}
                        className={`flex items-center gap-3 p-3 hover:bg-gray-50 border-b last:border-b-0 ${
        ...
        <div className="mb-3 sm:mb-4">
          <h2 className="text-lg sm:text-xl font-semibold">
            {subCategoryInfo ? `${subCategoryInfo.name} Products` : "Products"}{" "}
            ({data.length})
          </h2>
        </div>
